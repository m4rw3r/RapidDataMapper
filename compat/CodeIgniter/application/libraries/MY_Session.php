...
class MY_Session extends CI_Session
{
	 ...
	 *
	 * Original code from CodeIgniter, but modified database interaction.
	 *
	 * @return	bool
	 */
	public function sess_read()
	{
		...
		if($this->sess_use_database === TRUE)
		{
			...
			{
				$q->where('user_agent', $session['user_agent']);
			}
	 ...
	 *
	 * Original code from CodeIgniter, modified database interaction.
	 *
	 * @return	void
	 */
	function sess_write()
	...
	public function _sess_gc()
	{
		...
		if((rand() % 100) < $this->gc_probability)
		{
			...
			$this->CI->db->delete($this->sess_table_name, array('last_activity < ' => $expire));
