...
--EXPECTREGEX--
Fatal error: Uncaught exception 'Rdm_Adapter_ConnectionException' with message 'Could not connect to database "default": 2002, php_network_getaddresses: getaddrinfo failed: nodename nor servname provided, or not known'.*