...
$c = new '.$rel->getRelatedDescriptor()->getNamespace(true, true).$rel->getRelatedDescriptor()->getCollectionClassName().'($this, new '.$rel->getRelationFilterClassName().', empty($this->parent) ? \''.$rel->getName().'\' : $this->table_alias.\'_'.$rel->getName().'\');');
