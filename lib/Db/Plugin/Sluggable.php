...
class Db_Plugin_Sluggable extends Db_Plugin
{
	...
	function __construct(array $columns, $callable = 'Db_Plugin_Sluggable::filterString')
	{
		...
		{
			throw new Db_Exception_InvalidCallable('Erroneous callable format');
		}
		...
		if(count($callable) == 2)
		{
			...
			{
				throw new Db_Exception_InvalidCallable('Callable is not possible to call from the generated mapper.');
			}
		...
		{
			throw new Db_Exception_InvalidCallable('Callable can not be found.');
		}
