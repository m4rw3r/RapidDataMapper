...
class Db_Query_Select extends Db_Query
{
	 ...
	 * Adds a column.
	 * 
	 * @param  string|array|Db_Query_Select
	...
	{
		// do not iterate Db_Query_Select objects
		if($columns instanceof Db_Query_Select)
		{
		...
		{
			// subquery
			if($col instanceof Db_Query_Select)
			{
				if(is_numeric($alias))
				{
	 ...
	 * 
	 * @param  array|string|Db_Query_Select 
	 * @param  array|string
	 * @return self
	 */
	 ...
	 *
	 * @see Db_Query_Base::where()
	 *
	 * @param  string|array|Db_Query_Select		NOTE: Only one table is joined, array is used to alias it
	 * @param  string|array 					Parameters like the Db_Query_base::where() method (array style)
	 * @param  string|array
