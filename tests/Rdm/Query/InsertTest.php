...
require_once dirname(__FILE__).'/../../../lib/Rdm/Query/Insert.php';

/**
 * @covers Rdm_Query_Insert
 * @runTestsInSeparateProcesses enabled
 * @preserveGlobalState disabled
 */
class Rdm_Query_InsertTest extends PHPUnit_Framework_TestCase
{
	// ------------------------------------------------------------------------
	...
	{
		$i = $this->getMock('Rdm_Adapter', array('escape', 'protectIdentifiers'));
		$i->dbprefix = '';
...
VALUES (escbaz, escbaz2)', $q->getSQL());
	...
	public function testSet3()
	{
		...
		$sq = $this->getMock('Rdm_Query_Select', array('__toString', 'limit'));
...
VALUES (escbaz)', $q->getSQL());
	...
	{
		$i = $this->getMock('Rdm_Adapter', array('escape', 'protectIdentifiers', 'query'));
		$i->dbprefix = 'foobar_';
